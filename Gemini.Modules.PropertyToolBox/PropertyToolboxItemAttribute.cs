...
namespace Gemini.Modules.PropertyToolBox
{
    ...
    public class PropertyToolboxItemAttribute : Attribute
    {
        public PropertyToolboxItemAttribute(Type documentType, string name, string category, int order, string iconSource = null, object content = null, Type resourceType = null)
        {
